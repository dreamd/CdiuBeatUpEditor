...
Public Declare Function FSOUND_Stream_Open2 Lib "fmod.dll" Alias "_FSOUND_Stream_Open@16" (data As Any, ByVal Mode As FSOUND_MODES, ByVal OffSet As Long, ByVal Length As Long) As Long
